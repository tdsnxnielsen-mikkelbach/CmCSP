...
| Phase 6 | Cost-insight enrichment (same ARM token): native forecast, Marketplace spend split, anomaly detection, reservation utilization trend | — | 📋 Planned | [phase6.md](phases/phase6.md) |
| Phase 7 | Azure inventory & optimization: Resource Graph enrichment, orphaned-resource finder, reservation/savings-plan purchase recommendations | — | 📋 Planned | [phase7.md](phases/phase7.md) |
...
|---|---|---|---|---|
| Phase 6 | Cost-insight enrichment (same ARM token) | P1 | 📋 Planned | [phase6.md](phases/phase6.md) |
| Phase 7 | Azure inventory & optimization | P1 | 📋 Planned | [phase7.md](phases/phase7.md) |
